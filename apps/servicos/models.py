...
class OrdemServico(models.Model):
    ...
    veiculo = models.CharField(verbose_name='Veículo', max_length=100, help_text='Ex: Honda Fan 160')
    placa = models.CharField(verbose_name='Placa', max_length=8, help_text='Ex: AAA-0B00')
